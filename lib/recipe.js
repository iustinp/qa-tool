...
const DEFAULT_RECIPE = {
  ...
  ignoreSource: [], // [{ selector, reason }] — removed from the SOURCE capture only
  ignoreTarget: [], // [{ selector, reason }] — removed from the TARGET capture only
...
function validateRecipe(recipe) {
  ...
  for (const key of ['ignore', 'ignoreSource', 'ignoreTarget']) {
