      ...
      if (layoutCrawl) {
        ...
        try {
          ...
          const [srcCrawl, tgtCrawl] = await Promise.all([
            crawlUrl(source, { maxTriggers: 120, settleMs: 280, captureStates: true, maxStates: 40, captureOptions: resolvedCaptureOptions }),
            crawlUrl(target, { maxTriggers: 120, settleMs: 280, captureStates: true, maxStates: 40, captureOptions: resolvedCaptureOptions }),
          ]);
