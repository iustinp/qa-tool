...
async function processPair(
  ...
  try {
    ...
    const crawlOpts = layoutCrawl
      ? // pixelDetect is OFF by default: validated (opts.pixelDetect) but ~3x the
        // run cost as-is (full-page diff + OCR per text-flat click on a tall page),
        // which eats the time budget and truncates coverage. Enable once P4 cost
        // hardening lands (downscale-for-detection + region-scoping) — see #62.
