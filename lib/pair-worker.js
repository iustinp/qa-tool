        ...
        try {
          ...
          const buildGraph = (crawl, side) => {
            ...
            (crawl.states || []).forEach((st, i) => {
              ...
              const kids = (crawl.edges || [])
                .filter((e) => e.kind === 'new' && e.fromSig === st.signature)
                .map((e) => ({ sig: e.toSig, label: e.triggerLabel, x: e.triggerX, y: e.triggerY, w: e.triggerW, h: e.triggerH, hidden: e.hidden, ghost: e.ghost }));
              states[st.signature] = {
                id: `${side}-${i}`,
            ...
            const baseChildren = (crawl.edges || [])
              .filter((e) => e.kind === 'new' && e.fromSig === base)
              .map((e) => ({ sig: e.toSig, label: e.triggerLabel, x: e.triggerX, y: e.triggerY, w: e.triggerW, h: e.triggerH, hidden: e.hidden, ghost: e.ghost }));
