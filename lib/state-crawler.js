  ...
  return page.evaluate(
    ({ SEL, ITEM, DBG }) => {
      ...
      for (const el of document.querySelectorAll('*')) {
        ...
        // tab-switch swaps in others) and its cards must each be a click target. Detect
        ...
        // row), then require its children to be a horizontal ROW of >=2 SIMILAR-sized
        // items (the carousel signature; guards against generic clipped / 2-col content).
        ...
        for (const ch of items) addCand(ch, 'scroll-item');
      }
