...
function fillSide(){ const s=el('side'); const txt=i=>!i.img;
  ...
  el('stat').innerHTML='<small>'
    +(a.healthScore!=null?'<b title="overall page health — HIGHER is BETTER, 100 = perfect (0.7·content + 0.3·(100−drift)). Text only; images not yet scored.">General Health '+a.healthScore+'/100</b>':'')
