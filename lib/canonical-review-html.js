...
function buildCanonicalReviewHtml(o) {
  ...
  const srcHiddenCanvas = renderPearNodes({ nodes: o.sourceClm?.hiddenNodes || [] });
  const tgtHiddenCanvas = renderPearNodes({ nodes: o.targetClm?.hiddenNodes || [] });
...
<style>
  ...
  *{box-sizing:border-box}
  ...
  .hiddenlayer{background:transparent;z-index:1;opacity:0.6;pointer-events:none}
